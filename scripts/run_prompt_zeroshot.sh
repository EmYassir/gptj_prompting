...
export OUTPUT_DIR=/media/data/yassir/output/gptj_prompt/$DATASET_NAME/$TASK_NAME/$MODEL_TYPE/$METHOD
...
#python $RUNNER \
#--fp16 \
#--method prefix_sequence_classifier \
#--pattern_ids 0 1 2 \
#--data_dir $DATA_DIR \
#--model_type $MODEL_TYPE \
#--model_name_or_path $MODEL_TYPE \
#--sc_per_gpu_train_batch_size $TRAIN_BATCH_SIZE \
#--sc_gradient_accumulation_steps $GRAD_ACC \
